...
namespace SalesWebMcv.Data
{
    public class SeedingService
    {
        ...
        public void Seed() 
        {
            ...
            Seller s5 = new Seller("Donald Blue", "donal@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller("Alex Pink", "alexp@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
